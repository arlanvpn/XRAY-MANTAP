...
<p align='center'><a href="https://api.daily.dev/get?r=fisabiliyusri"><img src="https://raw.githubusercontent.com/arlanvpn/.github/main/kotori2.png?r=82s" width="150" alt="Hayuk"/></a></p>

<p align="center">
<img height=21 src="https://komarev.com/ghpvc/?username=arlanvpn">
</p>
<div height='45' align="center">
<h2>Contact me: <br>
<a href="https://facebook.com/arlan.alghozali"> <img src="https://cdn.jsdelivr.net/npm/simple-icons@3.0.1/icons/facebook.svg" height='50'> </a>
<h2>Support me: <br>
<a href="https://trakteer.id/arlan-l/tip"> <img src="https://cdn.trakteer.id/images/embed/trbtn-red-6.png" height='50'> </a>
</h2>
</div>
#
...
* Link:
https://github.com/arlanvpn/XRAY-FOR-ANDROID
...
2. Pointing Dulu Domain Kamu, Kalo sudah pernah di pointing
   ...
   ![settinggambar1](https://raw.githubusercontent.com/arlanvpn/XRAY-MANTAP/main/img/settingambar1.jpg)
   ![settinggambar2](https://raw.githubusercontent.com/arlanvpn/XRAY-MANTAP/main/img/settingambar2.jpg)
   ![settinggambar3](https://raw.githubusercontent.com/arlanvpn/XRAY-MANTAP/main/img/settingambar3.jpg)
   - Lalu pilih Edge Certificates disini kamu harus matikan Always Use HTTPS (Harus Mati/OFF)❌
   ![settinggambar4](https://raw.githubusercontent.com/arlanvpn/XRAY-MANTAP/main/img/settingambar4.jpg)
   - Buka tab Network di cloudflare kamu aktifkan WebSocket nya ✅
   ![settinggambar5](https://raw.githubusercontent.com/arlanvpn/XRAY-MANTAP/main/img/settingambar5.jpg)
   ![settinggambar6](https://raw.githubusercontent.com/arlanvpn/XRAY-MANTAP/main/img/settingambar6.jpg)
...
```
wget https://raw.githubusercontent.com/arlanvpn/XRAY-MANTAP/main/setup.sh && chmod +x setup.sh && ./setup.sh
```
...
```
- contoh punya aku
- tinggal ubah saja yg arlanhaerudin.my.id menjadi domain punya kamu
```
DOMAIN=arlanhaerudin.my.id
SUB_DOMAIN=onichan-${sub}.arlanhaerudin.my.id
